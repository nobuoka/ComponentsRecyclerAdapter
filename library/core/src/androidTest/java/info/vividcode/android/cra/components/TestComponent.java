...
class TestComponent<T> implements info.vividcode.android.cra.Component {

    public TestComponent() {
    }

    public TestComponent(Collection<T> items) {
        this();
        mItems = new ArrayList<>(items);
    }

    public TestComponent(Collection<T> items, Collection<Integer> itemViewTypes) {
        this();
        mItems = new ArrayList<>(items);
